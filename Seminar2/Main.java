...
public class Main {
    ...
    public static void num1(){
        //Задание1.Реализуйте метод, который запрашивает у пользователя ввод дробного числа (типа float),
    ...
    public static void num3(){
        //Задание3.сли необходимо, исправьте данный код
        //
        //        try {
        //            int a = 90;
        //            int b = 3;
        ...
        //            System.out.println("Невозможно указывать на null!");
        //        } catch (ArrayIndexOutOfBoundsException ex) {
        //            System.out.println("Выход индекса массива за пределы допустимого диапазона!");
        //        } catch (Exception ex) {
        ...
        try {
            ...
            System.out.println("Выход массива за пределы своего размера!");
        }catch (Exception num) {
            System.out.println("Что-то пошло не так...");
        }
    }
    ...
    public static void num4(){
        ...
        //Задание4.Разработайте программу, которая выбросит Exception, когда пользователь вводит пустую строку.
    ...
    private static String getTextFromUser(Object bufferedReader) {
        return null;
    }
    ...
    public static float getFloatFromUser(BufferedReader bufferedReader){
        ...
        try {
            ...
            System.out.println("Ошибка при преобразовании введенного значения в число с плавающей точкой");
